...
cleanGeoms <- function(polygonFileList) {
    for(i in 1:length(polygonFileList)) {
        ...
        # Clean the spatial objects (takes about 1 minute on poly_unun_7_2002 with 400+ polygons)
...
shapeComp <- data.frame()
#############################################
# Test on one shapefile example case
shpToSPDF <- readShapePoly("C:\\Users\\Darin\\Documents\\rWorkingDir\\projectFiles\\idahoSpatialData\\working_data\\msData\\nonEdgePolys\\Q1_32_C_cleaned_edgeRmv.shp")

# Calculate the area of each polygon
shpToSPDF$area <- gArea(shpToSPDF, byid = TRUE)

# Calculate perimeter of each polygon


# Define a function for calculating the Shape Complexity Index
sci <- function(shapes) {
